import{r as n,W as w,m as e}from"./finder-jA3j65ul.js";function g(){const{onClose:r,onMinimize:l,onZoom:d,onTitleMouseDown:m}=n.useContext(w),i=[{id:1,title:"Histories",content:`Love arrives
...
Tell me your dreams, your desires, and your fears, and I promise I’ll be right here. You deserve to be loved in a way that feels right to you, and I’m willing to do whatever it takes to be the person you need, because you are my number one.`,modified:"Today"}],[o,h]=n.useState(i),[s,c]=n.useState(i[0].id),u=o.find(t=>t.id===s),y=t=>{h(f=>f.map(a=>a.id===s?{...a,content:t,modified:"Just now"}:a))};return e.jsxs("div",{className:"notes",children:[e.jsxs("div",{className:"notes-titlebar",onMouseDown:t=>!t.target.closest(".notes-traffic-light")&&m(t),children:[e.jsxs("div",{className:"notes-traffic-lights",children:[e.jsx("button",{className:"notes-traffic-light notes-traffic-light--close",onClick:r,title:"Close"}),e.jsx("button",{className:"notes-traffic-light notes-traffic-light--minimize",onClick:l,title:"Minimize"}),e.jsx("button",{className:"notes-traffic-light notes-traffic-light--zoom",onClick:d,title:"Zoom"})]}),e.jsx("span",{className:"notes-title",children:"Notes"})]}),e.jsxs("div",{className:"notes-body",children:[e.jsxs("div",{className:"notes-sidebar",children:[e.jsxs("div",{className:"notes-sidebar-header",children:["ALL NOTES — ",o.length]}),e.jsx("div",{className:"notes-list",children:o.map(t=>e.jsxs("div",{className:`notes-list-item ${s===t.id?"active":""}`,onClick:()=>c(t.id),children:[e.jsx("div",{className:"notes-item-title",children:t.title}),e.jsx("div",{className:"notes-item-modified",children:t.modified})]},t.id))})]}),e.jsx("textarea",{className:"notes-editor",value:u?.content||"",onChange:t=>y(t.target.value),placeholder:"Start writing..."})]})]})}export{g as NotesContent};
