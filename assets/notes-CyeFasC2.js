import{r as s,W as w,m as e}from"./finder-DEuCFLFY.js";function v(){const{onClose:i,onMinimize:r,onZoom:l,onTitleMouseDown:h}=s.useContext(w),d=[{id:1,title:"Histories",content:`Love arrives
...
Tell me your dreams, your desires, and your fears, and I promise I’ll be right here. You deserve to be loved in a way that feels right to you, and I’m willing to do whatever it takes to be the person you need, because you are my number one.`,modified:"Today"},{id:5,title:"Without Having You",content:`I’m sorry for what happened the other day.
...
Whatever happens from here, thank you for being someone I was able to care about this deeply.`,modified:"Today"}],[o,m]=s.useState(d),[a,u]=s.useState(5),y=o.find(t=>t.id===a),c=t=>{m(f=>f.map(n=>n.id===a?{...n,content:t,modified:"Just now"}:n))};return e.jsxs("div",{className:"notes",children:[e.jsxs("div",{className:"notes-titlebar",onMouseDown:t=>!t.target.closest(".notes-traffic-light")&&h(t),children:[e.jsxs("div",{className:"notes-traffic-lights",children:[e.jsx("button",{className:"notes-traffic-light notes-traffic-light--close",onClick:i,title:"Close"}),e.jsx("button",{className:"notes-traffic-light notes-traffic-light--minimize",onClick:r,title:"Minimize"}),e.jsx("button",{className:"notes-traffic-light notes-traffic-light--zoom",onClick:l,title:"Zoom"})]}),e.jsx("span",{className:"notes-title",children:"Notes"})]}),e.jsxs("div",{className:"notes-body",children:[e.jsxs("div",{className:"notes-sidebar",children:[e.jsxs("div",{className:"notes-sidebar-header",children:["ALL NOTES — ",o.length]}),e.jsx("div",{className:"notes-list",children:o.map(t=>e.jsxs("div",{className:`notes-list-item ${a===t.id?"active":""}`,onClick:()=>u(t.id),children:[e.jsx("div",{className:"notes-item-title",children:t.title}),e.jsx("div",{className:"notes-item-modified",children:t.modified})]},t.id))})]}),e.jsx("textarea",{className:"notes-editor",value:y?.content||"",onChange:t=>c(t.target.value),placeholder:"Start writing..."})]})]})}export{v as NotesContent};
