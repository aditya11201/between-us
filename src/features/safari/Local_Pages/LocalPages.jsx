...
export const AboutPage = () => (
  <div className="sf-local-page">
    <div className="sf-glass-card about-card">
      ...
      <p className="sf-subtitle"><strong>Between Us</strong> – A personal macOS-inspired experience.</p>
...
export const HackintoshPage = () => (
  <div className="sf-local-page">
    <div className="sf-glass-card">
      ...
      <h1 className="sf-title">Between Us</h1>
      <p className="sf-description">
        A personal macOS-inspired browser experience, running directly in your browser. No hardware required.
      </p>
      <a 
